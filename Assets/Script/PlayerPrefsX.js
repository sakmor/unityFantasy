...
static
function SetVector2(key: String, vector: Vector2): boolean {
...
static
function GetVector2(key: String, defaultValue: Vector2): Vector2 {
...
static
function SetVector3(key: String, vector: Vector3): boolean {
...
static
function GetVector3(key: String, defaultValue: Vector3): Vector3 {
    if (PlayerPrefs.HasKey(key)) {
...
static
function SetQuaternion(key: String, vector: Quaternion): boolean {
    return SetFloatArray(key, [vector.x, vector.y, vector.z, vector.w]);
}

static
function GetQuaternion(key: String): Quaternion {
    var floatArray = GetFloatArray(key);
...
static
function GetQuaternion(key: String, defaultValue: Quaternion): Quaternion {
    if (PlayerPrefs.HasKey(key)) {
...
static
function SetColor(key: String, color: Color): boolean {
...
static
function GetColor(key: String, defaultValue: Color): Color {
    if (PlayerPrefs.HasKey(key)) {
        return GetColor(key);
    }
    return defaultValue;
...
static
function SetBoolArray(key: String, boolArray: boolean[]): boolean {
...
static
function GetBoolArray(key: String): boolean[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetBoolArray(key: String, defaultValue: boolean, defaultSize: int): boolean[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function SetStringArray(key: String, stringArray: String[]): boolean {
...
static
function GetStringArray(key: String, defaultValue: String, defaultSize: int): String[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function SetIntArray(key: String, intArray: int[]): boolean {
    return SetValue(key, intArray, ArrayType.Int32, 1, ConvertFromInt);
}

static
function SetFloatArray(key: String, floatArray: float[]): boolean {
    return SetValue(key, floatArray, ArrayType.Float, 1, ConvertFromFloat);
}

static
function SetVector2Array(key: String, vector2Array: Vector2[]): boolean {
    return SetValue(key, vector2Array, ArrayType.Vector2, 2, ConvertFromVector2);
}

static
function SetVector3Array(key: String, vector3Array: Vector3[]): boolean {
    return SetValue(key, vector3Array, ArrayType.Vector3, 3, ConvertFromVector3);
}

static
function SetQuaternionArray(key: String, quaternionArray: Quaternion[]): boolean {
    return SetValue(key, quaternionArray, ArrayType.Quaternion, 4, ConvertFromQuaternion);
}

static
function SetColorArray(key: String, colorArray: Color[]): boolean {
    return SetValue(key, colorArray, ArrayType.Color, 4, ConvertFromColor);
}

private static
function SetValue(key: String, array: IList, arrayType: ArrayType, vectorNumber: int, convert: function (IList, byte[], int)): boolean {
    if (array.Count == 0) {
...
private static
function ConvertFromInt(array: int[], bytes: byte[], i: int) {
    ConvertInt32ToBytes(array[i], bytes);
}

private static
function ConvertFromFloat(array: float[], bytes: byte[], i: int) {
    ConvertFloatToBytes(array[i], bytes);
}

private static
function ConvertFromVector2(array: Vector2[], bytes: byte[], i: int) {
    ConvertFloatToBytes(array[i].x, bytes);
    ConvertFloatToBytes(array[i].y, bytes);
}

private static
function ConvertFromVector3(array: Vector3[], bytes: byte[], i: int) {
    ConvertFloatToBytes(array[i].x, bytes);
    ConvertFloatToBytes(array[i].y, bytes);
...
private static
function ConvertFromQuaternion(array: Quaternion[], bytes: byte[], i: int) {
    ConvertFloatToBytes(array[i].x, bytes);
    ConvertFloatToBytes(array[i].y, bytes);
    ConvertFloatToBytes(array[i].z, bytes);
...
private static
function ConvertFromColor(array: Color[], bytes: byte[], i: int) {
...
static
function GetIntArray(key: String): int[] {
...
static
function GetIntArray(key: String, defaultValue: int, defaultSize: int): int[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetFloatArray(key: String): float[] {
...
static
function GetFloatArray(key: String, defaultValue: float, defaultSize: int): float[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetVector2Array(key: String): Vector2[] {
...
static
function GetVector2Array(key: String, defaultValue: Vector2, defaultSize: int): Vector2[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetVector3Array(key: String): Vector3[] {
...
static
function GetVector3Array(key: String, defaultValue: Vector3, defaultSize: int): Vector3[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetQuaternionArray(key: String): Quaternion[] {
...
static
function GetQuaternionArray(key: String, defaultValue: Quaternion, defaultSize: int): Quaternion[] {
    if (PlayerPrefs.HasKey(key)) {
...
static
function GetColorArray(key: String): Color[] {
...
static
function GetColorArray(key: String, defaultValue: Color, defaultSize: int): Color[] {
    if (PlayerPrefs.HasKey(key)) {
...
private static
function GetValue(key: String, list: IList, arrayType: ArrayType, vectorNumber: int, convert: function (IList, byte[])) {
    if (PlayerPrefs.HasKey(key)) {
        var bytes = System.Convert.FromBase64String(PlayerPrefs.GetString(key));
...
private static
function ConvertToInt(list: List. < int > , bytes: byte[]) {
    list.Add(ConvertBytesToInt32(bytes));
}

private static
function ConvertToFloat(list: List. < float > , bytes: byte[]) {
    list.Add(ConvertBytesToFloat(bytes));
}

private static
function ConvertToVector2(list: List. < Vector2 > , bytes: byte[]) {
    list.Add(Vector2(ConvertBytesToFloat(bytes), ConvertBytesToFloat(bytes)));
}

private static
function ConvertToVector3(list: List. < Vector3 > , bytes: byte[]) {
    list.Add(Vector3(ConvertBytesToFloat(bytes), ConvertBytesToFloat(bytes), ConvertBytesToFloat(bytes)));
}

private static
function ConvertToQuaternion(list: List. < Quaternion > , bytes: byte[]) {
...
private static
function SaveBytes(key: String, bytes: byte[]): boolean {
    try {
...
private static
function ConvertBytesToFloat(bytes: byte[]): float {
    ConvertFrom4Bytes(bytes);
    return System.BitConverter.ToSingle(byteBlock, 0);
}

private static
function ConvertInt32ToBytes(i: int, bytes: byte[]) {
    byteBlock = System.BitConverter.GetBytes(i);
    ConvertTo4Bytes(bytes);
}

private static
function ConvertBytesToInt32(bytes: byte[]): int {
    ConvertFrom4Bytes(bytes);
    return System.BitConverter.ToInt32(byteBlock, 0);
}

private static
function ConvertTo4Bytes(bytes: byte[]) {
...
private static
function ConvertFrom4Bytes(bytes: byte[]) {

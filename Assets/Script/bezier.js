...
@
script RequireComponent(UnityEngine.LineRenderer)
    //[RequireComponent(typeof (LineRenderer))]

//var controlPoints: Transform = new Array();
var controlPoints = new List. < UnityEngine.Transform > ();
//    public Transform[] controlPoints;
var lineRenderer: UnityEngine.LineRenderer;
...
function start() {
    ...
    var temp = 4;
    curveCount = Mathf.FloorToInt(temp / 3);
}
